...
func NewWardleServerOptions(out, errOut io.Writer) *WardleServerOptions {
	o := &WardleServerOptions{
		RecommendedOptions: genericoptions.NewRecommendedOptions(
			...
			apiserver.Codecs.CodecForVersions(protobuf.NewSerializer(apiserver.Scheme, apiserver.Scheme), protobuf.NewSerializer(apiserver.Scheme, apiserver.Scheme), v1beta1.SchemeGroupVersion, wardle.SchemeGroupVersion),
		),
